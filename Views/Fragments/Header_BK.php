<header >
        ...
        <a href="./index.php">    
        <img src="./Img/Logo2.png" alt="LogoRode" class="Mi_logo" style="height: 85px; width: 96px;"></a> 
        </div>
        ...
        <nav id="navbar">
            ...
            <div class="SearchBar">
                <form class="d-flex m-4 b-4" role="search">
                    ...
                    <button class="btn btn-outline-success" id="Button_Search" type="submit"                     
                    onmouseover="this.style.backgroundColor='#007bff';" 
                      
                      onmouseout="this.style.backgroundColor='#D4AF37';">Buscar
                    </button>
